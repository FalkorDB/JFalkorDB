...
public interface GraphTransaction
     ...
     * containers, non-String map keys, and invalid parameter names are rejected with
     * {@link IllegalArgumentException}. This safety covers parameter values only — not the query text
     * itself, dynamic labels/identifiers, or procedure names.
     *
     * @param query Cypher query.
