...
public class ListGraphsTest {
    ...
    public void testListGraphsWithCreatedGraph() {
        ...
        try {
            ...
            Assertions.assertTrue(
                    graphs.contains("test-list-graph"), "Graph list should contain the created graph: " + graphs);
        } finally {
    ...
    public void testListGraphsAfterDeletion() {
        ...
        Assertions.assertFalse(
                graphsAfter.contains("test-delete-graph"),
    ...
    public void testListGraphsMultiple() {
        ...
        try {
            ...
            List<String> graphs = driver.listGraphs();
            Assertions.assertNotNull(graphs);
            Assertions.assertTrue(graphs.contains("test-multi-1"), "Graph list should contain test-multi-1: " + graphs);
            Assertions.assertTrue(graphs.contains("test-multi-2"), "Graph list should contain test-multi-2: " + graphs);
        } finally {
