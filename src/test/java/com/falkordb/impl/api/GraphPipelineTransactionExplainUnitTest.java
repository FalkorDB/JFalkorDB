...
public class GraphPipelineTransactionExplainUnitTest {
    ...
    public void testExplainResponseWithLongStrings() {
        ...
        List<Object> mockResponse =
                Arrays.asList(SafeEncoder.encode(longString.toString()), SafeEncoder.encode("Normal line"));
    ...
    public void testExplainResponseErrorHandling() {
        ...
        List<Object> responseWithNull =
                Arrays.asList(SafeEncoder.encode("Valid line"), null, SafeEncoder.encode("Another valid line"));
